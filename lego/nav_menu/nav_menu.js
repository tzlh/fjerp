...
function nav_menu_output(output_id) {
  var content = 
    ...
    '        <a href = "../index/index.html" class = "list-group-item clearfix nav_pl30">库区资金占用汇总</a>'+
    '        <a href = "../index/warehouse_payment_list.html" class = "list-group-item clearfix nav_pl30">库区资金占用列表</a>'+
