...
class materialTransfer {
  ...
  clearRawData() {
    ...
    $("#Exit_R_i_l").html("");
    $("#Exit_R_m_l").html("");
    $("#Exit_R_d_r_10_e_t").html("");
    $("#Exit_R_d_r_50_e_t").html("");
    $("#Exit_R_d_r_90_e_t").html("");
    $("#Exit_R_f_b_p").html("");
    $("#Exit_R_r_l").html("");
    $("#Exit_R_v_p").html("");
    $("#Exit_R_s_w_g").html("");
    ...
    $("#Exit_R_a_a").html("");
    $("#Exit_R_o_l").html("");
    $("#Exit_R_carbinol").html("");
    $("#Exit_R_d_v").html("");
    $("#Exit_R_d_p_i").html("");
    $("#Exit_R_ethanol").html("");
    $("#Exit_R_silicon").html("");
    $("#Exit_R_methylaniline").html("");
    $("#Exit_R_formal").html("");
    $("#Exit_R_d_s").html("");
    $("#Exit_R_s_b_a").html("");
    $("#Exit_R_c_l").html("");
    ...
    // 清空储罐
    $("#selectWarehousePotIdExit").html(`<option value = "">--请选择--</option>`);
    $("#selectWarehousePotIdEntry").html(`<option value = "">--请选择--</option>`);
    // 原料类别
    ...
    if (isJsonObjectHasData(this.warehouseData)) {
      let warehouseContent = `<option value = "">--请选择--</option>`;
        for (let i = 0; i < this.warehouseData.length; i++) {
          warehouseContent += `<option value = "${this.warehouseData[i].uuid}" title = "${this.warehouseData[i].warehouseName}">${this.warehouseData[i].warehouseName}</option>`;
        }
      $("#selectWarehouseId").html(warehouseContent);
    } else {
      $("#selectWarehouseId").html(`<option value = "" title = "">--请选择--</option>`);
    }
  }
    ...
    if (isJsonObjectHasData(this.warehousePotData)) {
      let warehousePotContent = `<option value = "">--请选择--</option>`;
        for (let i = 0; i < this.warehousePotData.length; i++) {
          warehousePotContent += `<option value = "${this.warehousePotData[i].uuid}" title = "${this.warehousePotData[i].warehousePotName}">${this.warehousePotData[i].warehousePotName}</option>`;
        }
      $("#selectWarehousePotIdExit").html(warehousePotContent);
      $("#selectWarehousePotIdEntry").html(warehousePotContent);
    } else {
      $("#selectWarehousePotId").html(`<option value = "" title = "">--请选择--</option>`);
    }
  }
  ...
  fillVariableData() {
    if (isJsonObjectHasData(this.originalValueData)) {
      ...
      let entryPot = $("#selectWarehousePotIdEntry").find("option:selected").text();
      let entryQuantity = this.originalValueData.quantity;
      $("#entryTitle").html(warehouse + '-' + entryPot + '-' + entryQuantity + '吨');
    } else {
      $("#R_d_20_t").html("");
      $("#R_r_o_n").html("");
      $("#R_h_r_m").html("");
      ...
      let warehouse = $("#selectWarehouseId").find("option:selected").text();
      let entryPot = $("#selectWarehousePotIdEntry").find("option:selected").text();
      $("#entryTitle").html(warehouse + '-' + entryPot);
    }
    if (isJsonObjectHasData(this.originalValueDataExit)) {
      $("#Exit_R_d_20_t").html(this.originalValueDataExit.R_d_20_t);
      $("#Exit_R_r_o_n").html(this.originalValueDataExit.R_r_o_n);
      $("#Exit_R_h_r_m").html(this.originalValueDataExit.R_h_r_m);
      $("#Exit_R_l_l").html(this.originalValueDataExit.R_l_l);
      $("#Exit_R_i_l").html(this.originalValueDataExit.R_i_l);
      $("#Exit_R_m_l").html(this.originalValueDataExit.R_m_l);
      $("#Exit_R_d_r_10_e_t").html(this.originalValueDataExit.R_d_r_10_e_t);
      $("#Exit_R_d_r_50_e_t").html(this.originalValueDataExit.R_d_r_50_e_t);
      $("#Exit_R_d_r_90_e_t").html(this.originalValueDataExit.R_d_r_90_e_t);
      $("#Exit_R_f_b_p").html(this.originalValueDataExit.R_f_b_p);
      $("#Exit_R_r_l").html(this.originalValueDataExit.R_r_l);
      $("#Exit_R_v_p").html(this.originalValueDataExit.R_v_p);
      $("#Exit_R_s_w_g").html(this.originalValueDataExit.R_s_w_g);
      $("#Exit_R_u_g").html(this.originalValueDataExit.R_u_g);
      $("#Exit_R_o_s").html(this.originalValueDataExit.R_o_s);
      $("#Exit_R_s_l").html(this.originalValueDataExit.R_s_l);
      $("#Exit_R_d_t").html(this.originalValueDataExit.R_d_t);
      $("#Exit_R_m_s_l").html(this.originalValueDataExit.R_m_s_l);
      $("#Exit_R_c_c_3_h_50_t").html(this.originalValueDataExit.R_c_c_3_h_50_t);
      $("#Exit_R_w_s_ph").html(this.originalValueDataExit.R_w_s_ph);
      $("#Exit_R_m_i_w").html(this.originalValueDataExit.R_m_i_w);
      $("#Exit_R_b_l").html(this.originalValueDataExit.R_b_l);
      $("#Exit_R_a_l").html(this.originalValueDataExit.R_a_l);
      $("#Exit_R_t_a").html(this.originalValueDataExit.R_t_a);
      $("#Exit_R_a_a").html(this.originalValueDataExit.R_a_a);
      $("#Exit_R_o_l").html(this.originalValueDataExit.R_o_l);
      $("#Exit_R_carbinol").html(this.originalValueDataExit.R_carbinol);
      $("#Exit_R_d_v").html(this.originalValueDataExit.R_d_v);
      $("#Exit_R_d_p_i").html(this.originalValueDataExit.R_d_p_i);
      $("#Exit_R_ethanol").html(this.originalValueDataExit.R_ethanol);
      $("#Exit_R_silicon").html(this.originalValueDataExit.R_silicon);
      $("#Exit_R_methylaniline").html(this.originalValueDataExit.R_methylaniline);
      $("#Exit_R_formal").html(this.originalValueDataExit.R_formal);
      $("#Exit_R_d_s").html(this.originalValueDataExit.R_d_s);
      $("#Exit_R_s_b_a").html(this.originalValueDataExit.R_s_b_a);
      $("#Exit_R_c_l").html(this.originalValueDataExit.R_c_l);
      let warehouse = $("#selectWarehouseId").find("option:selected").text();
      let exitPot = $("#selectWarehousePotIdExit").find("option:selected").text();
      let exitQuantity = this.originalValueDataExit.quantity;
      $("#exitTitle").html(warehouse + '-' + exitPot + '-' + exitQuantity + '吨');
    } else {
      $("#Exit_R_d_20_t").html("");
      $("#Exit_R_r_o_n").html("");
      $("#Exit_R_h_r_m").html("");
      ...
      let warehouse = $("#selectWarehouseId").find("option:selected").text();
      let exitPot = $("#selectWarehousePotIdExit").find("option:selected").text();
      $("#exitTitle").html(warehouse + '-' + exitPot);
    }
  }
   ...
   * 获取导出罐原料指标
   */
  getWarehousePotMaterialIndexExit() {
    let pot_uuid = $("#selectWarehousePotIdExit").val();
   ...
   * 获取导入罐原料指标
   */
  getWarehousePotMaterialIndexEntry() {
  ...
  output() {
    let content = 
      `<div class = "panel panel-default panel-primary">
        <div class = "panel-heading">原料导罐</div>
        <div class = "panel-body" style="padding-bottom: 0;">
          <div class = "row">
            ...
            <div class = "col-md-4">
              <div class = "input-group pull-left">
                <span class = "input-group-addon">导出罐</span>
                <select class = "form-control" id = "selectWarehousePotIdExit">
                  <option class = "">--请选择--</option>
            ...
            <div class = "col-md-4">
              <div class = "input-group pull-left">
                <span class = "input-group-addon">导入罐</span>
                <select class = "form-control" id = "selectWarehousePotIdEntry">
                  <option class = "">--请选择--</option>
                  <option value = "1">A01</option>
                  <option value = "2">A02</option>
                </select>
          ...
          <div class = "row material_transfer_mt20">
            <div class = "col-md-4">
              <div class = "input-group pull-left">
            ...
            <div class = "col-md-1">
              <div class = "form-group">
                <button type = "button" class = "btn btn-default" id = "searchBtn" style = "width: 100px;">查询</button>
              </div>
            </div>
            <div class = "col-md-1" id  = "addMaterialEntryBtn" style = "display: none;">
               <div class = "form-group" style = "margin-bottom: 0;">
                 <button type = "button" class = "btn btn-primary">入库</button>
               </div>
             </div>
             <div class = "col-md-1" id  = "modifyMaterialEntryBtn" style = "display: none;">
               <div class = "form-group" style = "margin-bottom: 0;">
                 <button type = "button" class = "btn btn-primary">入库</button>
               </div>
             </div>
      ...
      <div class = "row">
        <div class = "col-md-3">
          <div class = "panel panel-default panel-primary">
            <div class = "panel-heading text-left" id = "exitTitle">舟山纳海-E01-5000吨</div>
            <div class = "panel-body table-responsive material_transfer_pd0">
              <table  class = "table contact_management_mt20" id = "exitMaterialIndex">
                <thead>
                  <tr>
                    <th>指标名称</th>
                    <th>指标数据</th>
                ...
                <tbody>
                  ...
                  <tr>
                    <td>铅含量</td>
                    <td id = "Exit_R_l_l">4.3</td>
                    </td>
                  </tr>
                  <tr>
                    <td>铁含量</td>
                    <td id = "Exit_R_i_l">1.8</td>
                    </td>
                  </tr>
                  <tr>
                    <td>锰含量</td>
                    <td id = "Exit_R_m_l">5.9</td>
                    </td>
                  </tr>
                  <tr>
                    <td>馏程10%蒸发温度</td>
                    <td id = "Exit_R_d_r_10_e_t">59</td>
                  </tr>
                  <tr>
                    <td>馏程50%蒸发温度</td>
                    <td id = "Exit_R_d_r_50_e_t">108</td>
                  </tr>
                  <tr>
                    <td>馏程90%蒸发温度</td>
                    <td id = "Exit_R_d_r_90_e_t">179</td>
                  </tr>
                  <tr>
                    <td>终馏点</td>
                    <td id = "Exit_R_f_b_p">199</td>
                  </tr>
                  <tr>
                    <td>残留量</td>
                    <td id = "Exit_R_r_l">1.9</td>
                  </tr>
                  <tr>
                    <td>蒸汽压</td>
                    <td id = "Exit_R_v_p">50</td>
                  </tr>
                  <tr>
                    <td>溶剂洗胶质</td>
                    <td id = "Exit_R_s_w_g">4.3</td>
                  </tr>
                  <tr>
                    <td>未洗胶质</td>
                    <td id = "Exit_R_u_g">28</td>
                  </tr>
                  <tr>
                    <td>诱导期（氧化安定性）</td>
                    <td id = "Exit_R_o_s">479</td>
                  </tr>
                  <tr>
                    <td>硫含量</td>
                    <td id = "Exit_R_s_l">39</td>
                  </tr>
                  <tr>
                    <td>博士实验</td>
                    <td id = "Exit_R_d_t">通过</td>
                  </tr>
                  <tr>
                    <td>硫醇硫含量</td>
                    <td id = "Exit_R_m_s_l">7.9</td>
                  </tr>
                  <tr>
                    <td>铜片腐蚀（3h，50℃）</td>
                    <td id = "Exit_R_c_c_3_h_50_t">1a</td>
                  </tr>
                  <tr>
                    <td>水溶性酸或碱</td>
                    <td id = "Exit_R_w_s_ph">0</td>
                  </tr>
                  <tr>
                    <td>机械杂质和水</td>
                    <td id = "Exit_R_m_i_w">0</td>
                  </tr>
                  <tr>
                    <td>苯含量</td>
                    <td id = "Exit_R_b_l">0.7</td>
                  </tr>
                  <tr>
                    <td>芳烃含量</td>
                    <td id = "Exit_R_a_l">34</td>
                  </tr>
                  <tr>
                    <td>总烯烃</td>
                    <td id = "Exit_R_t_a">18</td>
                  </tr>
                  <tr>
                    <td>烯烃+芳烃</td>
                    <td id = "Exit_R_a_a">59</td>
                  </tr>
                  <tr>
                    <td>氧含量</td>
                    <td id = "Exit_R_o_l">1.9</td>
                  </tr>
                  <tr>
                    <td>甲醇</td>
                    <td id = "Exit_R_carbinol">0.18</td>
                  </tr>
                  <tr>
                    <td>二烯值</td>
                    <td id = "Exit_R_d_v">0</td>
                  </tr>
                  <tr>
                    <td>驾驶性能指数</td>
                    <td id = "Exit_R_d_p_i">0</td>
                  </tr>
                  <tr>
                    <td>乙醇</td>
                    <td id = "Exit_R_ethanol">0.18</td>
                  </tr>
                  <tr>
                    <td>硅</td>
                    <td id = "Exit_R_silicon">0.09</td>
                  </tr>
                  <tr>
                    <td>甲基苯胺</td>
                    <td id = "Exit_R_methylaniline">0</td>
                  </tr>
                  <tr>
                    <td>甲缩醛</td>
                    <td id = "Exit_R_formal">0</td>
                  </tr>
                  <tr>
                    <td>硫酸二甲酯</td>
                    <td id = "Exit_R_d_s">0</td>
                  </tr>
                  <tr>
                    <td>乙酸仲丁酯</td>
                    <td id = "Exit_R_s_b_a">0</td>
                  </tr>
                  <tr>
                    <td>氯含量</td>
                    <td id = "Exit_R_c_l">9</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <div class = "col-md-9">
          <div class = "panel panel-default panel-primary">
            <div class = "panel-heading text-left" id = "entryTitle">舟山纳海-E02-4000吨</div>
            <div class = "panel-body table-responsive material_transfer_pd0">
              <table  class = "table contact_management_mt20" id = "entryMaterialIndex">
                <thead>
                  <tr>
                    <th>指标名称</th>
                    <th>原始值</th>
